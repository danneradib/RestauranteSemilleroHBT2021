...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	 ...
	 */
	@Autowired
	public WebSecurity(Environment environment, BCryptPasswordEncoder bCryptPassworEncoder, UsuariosService usuariosService) {
	...
	/**
	 * Este metodo permite realizar las configuraciones personalizadas
	...
	private AuthenticationFilter getAuthenticationFilter() throws Exception {
		AuthenticationFilter authenticationFilter = new AuthenticationFilter(usuariosService, environment, authenticationManager());
